                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-12 form-group">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <textarea class="form-control" name="ki" id="" rows="3"></textarea>
                                    </div>
                                    <!--<div class="col-md-12 form-group">
                                        <label>Enter Key Risk Indicator:</label>
                                        <select class="form-control choices" name="kri" id="processid">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <button name="addki" class="btn btn-lg btn-primary addki">Add KPI</button>
                                </div>
                                <div class="col-md-3">
