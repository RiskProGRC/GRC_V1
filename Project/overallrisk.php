                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <select onchange="display(this.value)" name="rcategory" id="" class="form-select">
                                        <option value="0">Select Risk Category</option>
                                        <?php
                                        foreach($showRiskCat as $riskcat){
                                            echo'
                                        <option value='.$riskcat["riskcat_id"].'>'.$riskcat["name"].'</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
