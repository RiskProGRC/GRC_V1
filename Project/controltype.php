                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <i class="fas fa-fw fa-plus"></i>Add Control Type</button>
...
<table class="table table-striped table-buss" id="table1">
                                ...
                                <?php
                                    ...
                                    echo' 
                                     <tr>
                                            <td>'.$ct["ctype_id"].'</td>
                                            <td style="max-width:180px;white-space:normal;padding:4px 8px;font-size:11px;">'.substr($ct["ct_name"],0,50).'...</td>
                                            <td>
