...
if (!ctype_digit((string)$planId) || $cls->planDetails($planId) === null) respond_error('Invalid annual plan.');
...
respond_ok($cls->additem($uid, $ip, $planId, $dept, $process, $risk, $auditTitle, $rating, $quarter, $days, $status));
