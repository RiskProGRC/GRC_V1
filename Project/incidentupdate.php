...
if ($iid === '') {
    respond_error('PLEASE ENTER INCIDENT');
} elseif ($incident === '') {
    ...
    respond_ok($incidentClass->updateincident($uid, $ip, $iid, $incident, $process, $risk, $dol, $actual, $expected, $potential, $recovery, $action));
}
